...
Created by uni xu (uniwow@sina.com) 2017/10/29
"""
...
class SkipGramModel:
    ...
    def visualize(self, visual_fld, num_visualize):
        ...
        with tf.Session() as sess:
            ...
            saver_embed.save(sess, os.path.join('graphs/word2vec/lr' + str(self.lr), 'model.ckpt'), 1)
